...
# =======================================================
# =*= CODE TO GENERATE JOBS FOR THE GNS PRE-TRAINING =*=
# =======================================================
...
'''
    TEST WITH
    python pre_train_builder.py --account=x --parent=y --mail=x@mail.com --time=31 --memory=16 --cpu=1 --number=1
'''
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="GNS pre-training job builder")
    ...
    f.write(f"python {BASIC_PATH}train/pre_train.py --path="+BASIC_PATH+" \n")
    f.write("deactivate\n")
    f.close()
