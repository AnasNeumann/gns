...
def scheduling_stage(target_instance : Instance, agents: list[(Module, str)], embedding_stack: Module, shared_critic: Module, solve_function: Callable, path: str, epochs: int, iterations:int, device: str, id: str, size: str, interactive: bool = False, debug_mode: bool=False):
    """
    ...
    for episode in range(iterations):
        ...
        loss, _, cmax, cost = solve_function(instance=target_instance, agents=agents, train=True, trainable=[0,1,0], device=device, debug_mode=debug_mode)
    ...
    _cost_TRACKER.save(path+directory.solutions+'/'+size+'/stage_1_cost_'+id)
    _Cmax_TRACKER.save(path+directory.solutions+'/'+size+'/stage_1_cmax_'+id)
    return agents, embedding_stack, shared_critic

def outsourcing_stage(target_instance : Instance, agents: list[(Module, str)], embedding_stack: Module, shared_critic: Module, solve_function: Callable, path: str, epochs: int, iterations:int, device: str, id: str, size: str, interactive: bool = False, debug_mode: bool=False):
    """
...
def multi_agent_stage(target_instance : Instance, agents: list[(Module, str)], embedding_stack: Module, shared_critic: Module, path: str, solve_function: Callable, epochs: int, iterations:int, device: str, id: str, size: str, start_time: int, interactive: bool = False, debug_mode: bool=False):
    """
...
def multi_stage_fine_tuning(agents: list[(Module, str)], embedding_stack: Module, shared_critic: Module, path: str, solve_function: Callable, device: str, id: str, size: str, interactive: bool = False, debug_mode: bool=False):
    ...
    agents, embedding_stack, shared_critic = scheduling_stage(_instance, agents, embedding_stack, shared_critic, solve_function, path, _epochs, _itrs, device, id, size, interactive, debug_mode)
    go_to_eval(agents)
    print("II. FINE TUNING STAGE 2: outsourcing agent")
    agents, embedding_stack, shared_critic = outsourcing_stage(_instance, agents, embedding_stack, shared_critic, solve_function, path, _epochs, _itrs, device, id, size, interactive, debug_mode)
    print("III. FINE TUNING STAGE 3: multi-agent")
    _best_obj, _best_episode, _time_to_best = multi_agent_stage(_instance, agents, embedding_stack, shared_critic, solve_function, path, _epochs, _itrs, device, id, size, _start_time, interactive, debug_mode)
